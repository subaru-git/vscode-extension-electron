...
function _refreshWindowList() {
  ...
  windows = _.sortBy(windows, function (e) {
    return e.project_name.toLowerCase();
  });
    ...
    case 38:
      {
        ...
        var active_index = _.findIndex(items, function (e) {
          return e.classList && e.classList.contains('active');
        });
